...
- In the editor, copy the contents from the `llm-cpu-custom-runtime.yaml` file in [vllm-cpu-custom-runtime.yaml](https://github.com/alexbarbosa1989/ai-playground/blob/main/rhoai2-cpu-tests/vllm-cpu-custom-runtime.yaml). It references the `quay.io/abarbosa/vllm-cpu:0.11.2` image built for these test purposes.
