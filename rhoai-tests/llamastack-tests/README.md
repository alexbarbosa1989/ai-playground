...
After testing the llamastack API successfully, it can be run the [llamastack.test.ipynb](https://github.com/alexbarbosa1989/ai-playground/blob/main/rhoai-tests/llamastack-tests/lsd-llama-milvus-inline.yaml) notebook, wich contains a basic usage for llamastack + embedding a document + RAG.
