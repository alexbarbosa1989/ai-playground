...
After testing the llamastack API successfully, it can be run the [llamastack.test.ipynb](llamastack-test.ipynb) notebook, wich contains a basic usage for llamastack + embedding a document + RAG.
